/*
Deployment script for Medicine
...
GO
:setvar DatabaseName "Medicine"
:setvar DefaultFilePrefix "Medicine"
...
GO
/*
The column [dbo].[Table1].[BastaTambal] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[Table1] DROP COLUMN [BastaTambal];
